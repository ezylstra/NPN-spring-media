...
include_1_7 <- ifelse(include_1 == TRUE & include_7 == TRUE, TRUE, FALSE)
...
# Change any figure heights that are 0 to 1 (won't matter since a height of 0 is only associated
# with phenophase classes that weren't evaluated)
