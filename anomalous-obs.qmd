...
# Logical indicating whether to identify Tukey outliers in addition to early 
...
We identified observations of plant phenophases in Nature's Notebook (NN) that were earlier than normal in 2025. We compared 2025 observations with observations collected in 2009-2024 for plants within `{r} radius` km and within `{r} elev_buffer` m elevation of the plant observed in 2025. We limited analyses to phenophases in four phenophase classes: initial vegetative growth (class 1), leaves or needles (3), flowers or cones (6), and open flowers or cones (7), and only evaluated whether an observation was early if there were at least 20 observations for that species and phenophase over 8 or more years between 2009 and 2024.

We classified a 2025 observation as ***early*** if it was earlier than 95% of first-of-year observations in 2009-2024, and as an ***outlier*** if it was a Tukey outlier (2025 observation earlier than Q1 - 1.5 \* IQR). We also noted if the observation was as early or earlier than the earliest date ever recorded in NN for that species, phenophase, and region (***earliest***).

In the tables below, we list all of the 2025 observations that were considered early or an outlier by phenophase class. Histograms displaying distribution of observations in prior years that were used to assess 2025 potential anomalies are at the bottom of the document.

```{r}
#| label: tbl-veg
#| tbl-cap: "Anomalous observations of initial vegetative growth. ID = individual plant identification number. No. Prior Obs. (Yrs) lists the number of 2009-2024 observations (with the associated number of years) that were used to determine whether a 2025 observation was anomalous or not."
...
```{r}
#| label: tbl-leaves
#| tbl-cap: "Anomalous observations of leaves or needles. ID = individual plant identification number. No. Prior Obs. (Yrs) lists the number of 2009-2024 observations (with the associated number of years) that were used to determine whether a 2025 observation was anomalous or not."
...
```{r}
#| label: tbl-flowers
#| tbl-cap: "Anomalous observations of flowers or cones. ID = individual plant identification number. No. Prior Obs. (Yrs) lists the number of 2009-2024 observations (with the associated number of years) that were used to determine whether a 2025 observation was anomalous or not."
...
#| tbl-cap: "Anomalous observations of open flowers or cones. ID = individual plant identification number. No. Prior Obs. (Yrs) lists the number of 2009-2024 observations (with the associated number of years) that were used to determine whether a 2025 observation was anomalous or not."
...
```{r}
#| label: fig-map
#| fig-cap: !expr glue::glue("Map of early observations of initial vegetative growth and early observations of open flowers or cones. Green leaves denote early observations of initial vegetative growth and purple flowers denote early observations of open flowers or cones. Circles delineate the areas containing plants observed in prior years that were used for comparison. Blue shading indicates areas that were cooler than normal as of {agdd_date} (>{abs(agdd_breaks[2])} deg F below 30-year normals for accumulated growing degree days with 32 deg F base); orange shading indicates areas that were warmer than normal as of {agdd_date} (>{agdd_breaks[3]} deg F above 30-year normals).")
...
#| label: fig-hists1
#| fig-cap: "Initial vegetative growth. Distributions of first-of-year observations in 2009-2024 that were used to assess whether a 2025 observation (red vertical line) was unusually early."
...
#| label: fig-hists2
#| fig-cap: "Leaves or needles. Distributions of first-of-year observations in 2009-2024 that were used to assess whether a 2025 observation (red vertical line) was unusually early."
...
#| label: fig-hists3
#| fig-cap: "Flowers or cones. Distributions of first-of-year observations in 2009-2024 that were used to assess whether a 2025 observation (red vertical line) was unusually early."
...
#| label: fig-hists4
#| fig-cap: "Open flowers or cones. Distributions of first-of-year observations in 2009-2024 that were used to assess whether a 2025 observation (red vertical line) was unusually early."
