---
title: "Anomalous spring observations, 2025"
date: 2/5/2025
format:
  html:
    page-layout: full
...
suppressMessages(library(rnpn))
suppressMessages(library(dplyr))
suppressMessages(library(lubridate))
suppressMessages(library(stringr))
suppressMessages(library(ggplot2))
suppressMessages(library(scales)) # To make integer axis labels
...
In the tables below, we list all of the 2025 observations that were considered early or an outlier by phenophase class. No. Prior Obs. (Yrs) lists the number of 2009-2024 observations (with the associated number of years) that were used to determine whether a 2025 observation was anomalous or not. Histograms displaying distribution of observations in prior years that were used to assess 2025 potential anomalies are at the bottom of the document

#### Observations of initial vegetative growth
...
#### Observations of leaves or needles
...
#### Observations of flowers or cones
...
#### Observations of open flowers or cones
...
**Map of early initial vegetative growth and open flower observations.** Green leaves denote early observations of initial vegetation growth and purple flowers denote early observations of open flowers or cones. Circles delineate the areas containing plants observed in prior years that were used for comparison. Blue shading indicates areas that were cooler than normal as of `{r} agdd_date` (\>`{r} abs(agdd_breaks[2])` deg F below 30-year normals for accumulated growing degree days with 32 deg F base); orange shading indicates areas that were warmer than normal as of `{r} agdd_date` (\>`{r} agdd_breaks[3]` deg F above 30-year normals).
...
**Initial vegetative growth.** Distributions of first-of-year observations in 2009-2024 that were used to assess whether a 2025 observation (red vertical line) was unusually early.

```{r, fig.width = hist_width, fig.height = hist_heights[1]}
plot_r_1
```

**Leaves or needles.** Distributions of first-of-year observations in 2009-2024 that were used to assess whether a 2025 observation (red vertical line) was unusually early.

```{r, fig.width = hist_width, fig.height = hist_heights[2]}
plot_r_3
```

**Flowers or cones.** Distributions of first-of-year observations in 2009-2024 that were used to assess whether a 2025 observation (red vertical line) was unusually early.

```{r, fig.width = hist_width, fig.height = hist_heights[3]}
plot_r_6
```

**Open flowers or cones.** Distributions of first-of-year observations in 2009-2024 that were used to assess whether a 2025 observation (red vertical line) was unusually early.
