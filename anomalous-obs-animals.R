...
# write.csv(current, "resources/current_animals_20250212.csv", row.names = FALSE)
# write.csv(prior, "resources/prior_animals_20250212.csv", row.names = FALSE)

# Compare current year observations with distribution of first observation dates
# for plants within xx km and xx m elevation ----------------------------------#

current <- read.csv("resources/current_animals_20250212.csv")
prior <- read.csv("resources/prior_animals_20250212.csv")
